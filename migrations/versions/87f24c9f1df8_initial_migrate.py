...
Revision ID: 87f24c9f1df8
Revises: 
Create Date: 2024-09-12 11:32:50.300198
...
def upgrade():
    ...
    sa.Column('question_type', sa.Enum('short_answer', 'multiple_choice', 'true_false', name='question_types'), nullable=False),
